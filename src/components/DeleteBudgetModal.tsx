...
export default function DeleteBudgetModal({ budget, isOpen, onClose, onConfirm }: DeleteBudgetModalProps) {
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/20 backdrop-blur-[2px]">
      ...
      <div className="relative w-full max-w-md mx-4 bg-white/90 backdrop-blur-xl border border-white/40 shadow-2xl rounded-xl p-8 flex flex-col gap-6 overflow-hidden">
        ...
        <div className="flex items-start justify-between relative z-10">
          <div className="flex flex-col gap-1">
            <div className="flex items-center gap-2 text-[#ba1a1a]">
              ...
              <h2 className="text-xl font-bold text-slate-900 tracking-tight">Delete Budget</h2>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="space-y-4 relative z-10">
          ...
          {/* Context Card (Selected Budget Preview) */}
          <div className="bg-slate-50/80 border border-slate-200/60 rounded-lg p-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                <div className="text-sm font-semibold text-slate-700 truncate capitalize">{budget.category}</div>
                <div className="text-xs text-slate-500 truncate capitalize">{budget.period} budget</div>
              </div>
            </div>
            <div className="text-sm font-bold ml-4 whitespace-nowrap text-slate-900">
